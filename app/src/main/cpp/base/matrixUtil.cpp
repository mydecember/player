...
void mtxApplyTransposeVec4(float* mtx, float* vec)
{
    float result[4] = {0.0};
    result[0] = vec[0] * mtx[0] + vec[1] * mtx[4] + vec[2] * mtx[8] + vec[3] * mtx[12];
    result[1] = vec[0] * mtx[1] + vec[1] * mtx[5] + vec[2] * mtx[9] + vec[3] * mtx[13];
    result[2] = vec[0] * mtx[2] + vec[1] * mtx[6] + vec[2] * mtx[10] + vec[3] * mtx[14];
    result[3] = vec[0] * mtx[3] + vec[1] * mtx[7] + vec[2] * mtx[11] + vec[3] * mtx[15];
    vec[0] = result[0];
    vec[1] = result[1];
    vec[2] = result[2];
    vec[3] = result[3];
...
void mtxApplyVec4(float* mtx, float* vec)
{
    float result[4] = {0.0};
    result[0] = vec[0] * mtx[0] + vec[1] * mtx[1] + vec[2] * mtx[2] + vec[3] * mtx[3];
    result[1] = vec[0] * mtx[4] + vec[1] * mtx[5] + vec[2] * mtx[6] + vec[3] * mtx[7];
    result[2] = vec[0] * mtx[8] + vec[1] * mtx[9] + vec[2] * mtx[10] + vec[3] * mtx[11];
    result[3] = vec[0] * mtx[12] + vec[1] * mtx[13] + vec[2] * mtx[14] + vec[3] * mtx[15];
    vec[0] = result[0];
    vec[1] = result[1];
    vec[2] = result[2];
    vec[3] = result[3];
